...
public class ServiceTemperature {
    ...
    /**
     * Constructeur de la classe ServiceTemperature. Comme toujours, le travail N°1 consiste à
     ...
     * formule standard "Fahrenheits = (
     * Celsius * 1.8 ) + 32" pour la conversion, sauf si la température fournie
     * n'est pas une température valable
     ...
     * formule standard "Kelvins = ( Celsius +
     * 273 )" pour la conversion, sauf si la température fournie n'est pas une
     * température valable (c'est-à-dire une
